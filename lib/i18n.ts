  ...
  bg: {
    ...
    hero: {
      ...
      ticker: [
        'Sunset Port Festival',
        '22 и 23 Август 2026',
        'Пристанище Поморие, България',
        'Черноморски Бряг',
        'Бутиков Фестивал на Открито',
      ],
    },
    lineup: {
      label: 'Лайн ъп',
    ...
    faq: {
      label: 'ЧЗВ',
      title: 'Въпроси',
      intro: 'Всичко, което трябва да знаете, преди да посетите Sunset Port Festival 2026 на Пристанище Поморие — билети, транспорт, настаняване, възрастови ограничения, правила за влизане, храна и напитки, опции за плащане и достъпност.',
      items: [
        {
        ...
        {
          q: 'В колко часа отварят портите?',
          a: 'Портите отварят в 17:00 и в двата фестивални дни. Събитието протича от залез до късните часове, с музика, храна, напитки и изненадващи моменти през цялата вечер.',
        },
        {
        ...
        },
        {
          ...
          a: 'Не. Повторното влизане не е разрешено, след като напуснете фестивалното място. Уверете се, че имате всичко необходимо, преди да влезете в Пристанище Поморие.',
        },
        {
          q: 'Какво да взема?',
          a: [
        ...
        {
          q: 'Какво се случва, ако вали?',
          a: [
            'Sunset Port Festival е открито събитие и е планирано да се проведе при нормални метеорологични условия. Препоръчваме да вземете лек водоустойчив слой на всякакъв случай.',
            'Ако екстремно време или обстоятелства извън контрола на организатора засегнат събитието, актуализациите ще бъдат споделени чрез официалния уебсайт и социалните медии.',
          ],
        },
        {
          q: 'Билетите подлежат ли на връщане или прехвърляне?',
          a: [
            'Билетите трябва да се купуват само от официални канали. Не купувайте билети от неофициални препродавачи.',
            'Възстановяванията обикновено се обработват чрез партньора за билети само когато организаторът ги разреши. Условията на Eventim гласят, че възстановяванията се извършват само когато организаторът упълномощи Eventim да обработи възстановяването при неговите условия.',
          ],
        },
        {
          q: 'Достъпно ли е мястото?',
          a: 'Пристанище Поморие разполага с равни, павирани зони и достъпни съоръжения. Ако имате специфични изисквания за достъпност, свържете се с екипа на фестивала преди събитието, за да могат да ви помогнат да планирате най-доброто изживяване.',
        },
        {
          q: 'Ще бъде ли обявена пълната програма и часовете на изпълнения?',
          a: 'Да. Пълната програма, графикът на артистите и часовете на изпълнения ще бъдат обявени по-близо до фестивала. Следете официалните канали на Sunset Port Festival за актуализации на лайнъпа, транспортни детайли и обявления за билети.',
        },
      ],
    },
    cta: {
      tag: 'Пристанище Поморие · България',
      line1: 'Не Изпускай',
      line2: '',
      highlight: 'Залеза',
      getTickets: 'Купи Билет',
